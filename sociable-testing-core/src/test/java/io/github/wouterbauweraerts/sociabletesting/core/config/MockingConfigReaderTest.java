...
class MockingConfigReaderTest {
    ...
    void readConfigReturnsExpected() {
        ...
        assertThat(mockingConfig.packages()).containsExactly("org.springframework.data.jpa.repository", "io.github.wouterbauweraerts.sociabletesting.core.dummies.mocking.mockpackage");
